...
SENTINEL tries to route orchestration requests to `http://atlas:8007` → Nothing responds → "No healthy orchestration engine available"
...
│                         OLYMPUS                                  │
│  ┌──────────────┐    ┌──────────────┐    ┌──────────────┐      │
│  │   SENTINEL   │───▶│    ATLAS     │───▶│   AGENTS     │      │
│  │  (Router)    │    │ (Orchestrator)│    │ (Executors)  │      │
│  │   :8006      │    │    :8007     │    │  :8008-8300  │      │
│  └──────────────┘    └──────────────┘    └──────────────┘      │
│         │                   │                    │              │
│         └───────────────────┴────────────────────┘              │
...
╔═══════════════════════════════════════════════════════════════════════════════╗
║                              ATLAS                                             ║
║                    The Titan Who Holds Up The Heavens                          ║
║                                                                                ║
║  Port: 8007                                                                    ║
║                                                                                ║
...
async def startup():
    ...
    print(f"🏛️ ATLAS Orchestration Engine started on port {ATLAS_PORT}")
...
echo "🏛️ Deploying ATLAS Orchestration Engine..."
...
echo ""
echo "🏛️ ATLAS Orchestration Engine deployed successfully!"
echo "   Port: 8007"
